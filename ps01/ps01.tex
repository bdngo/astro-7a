...
\begin{tikzpicture}
    \begin{axis}[
        title=Logarithm of Orbital Period vs. Logarithm of Semimajor Axis,
        xlabel = {\(\log(P) [\si{\day}]\)},
...
The \(y\)-intercept can be used to determine the mass of the central star because it represents a \(\log(P) = 0 \Rightarrow P = \SI{1}{\day} = \SI{86400}{\second}\), since the star cannot orbit itself.
Finding \(a\),
\begin{equation}
    a = 10^b = \SI{0.008747570954405929}{\astronomicalunit} \cdot \SI{149597870700}{\meter\per\astronomicalunit} = \SI{1.31d9}{\meter}
\end{equation}
Plugging in and letting \(m_1 + m_2\),
\begin{align}
    P^2 &= \frac{4 \pi^2}{G (2 m_1)}a^3 \\
    \Rightarrow m_1 &= \frac{2 \pi^2}{G P^2}a^3 = \SI{8.88d27}{\kilogram}
\end{align}
